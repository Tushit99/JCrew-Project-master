...
export const Navber = () => {
  const nav = [
    { title: "Home", to: "/" },
    // { title: "Boyshort22", to: "/Boyshort" },   
    // { title: "Getoutside", to: "/Getoutside" },
    { title: "Girlsgraphicsshop", to: "/Girlsgraphicsshop" },
    { title: "Graphicsshop", to: "/Graphicsshop" },
    { title: "TeesPolos", to: "/TeesPolos" },  
      // Active
      // Bag" 
      // BestSeller" 
      // BestSellersMen" 
  ...
  // document.getElementById("sign").addEventListener("click", num)
